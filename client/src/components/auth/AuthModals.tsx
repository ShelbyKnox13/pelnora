    ...
    <>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" onClick={onCloseLogin}>
          <div className="bg-white rounded-lg max-w-md w-full p-6 shadow-2xl mx-auto my-auto max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-6">
              <h2 className="font-elegant text-2xl font-bold text-charcoal-dark">Login to Your Account</h2>
            ...
            <form className="space-y-4" onSubmit={loginForm.handleSubmit(handleLogin)}>
              {loginStep === 'email' ? (
                <div>
                  ...
                  <Button
                    ...
                    className="w-full mt-4 bg-gold-dark hover:bg-gold text-white font-semibold py-3 shadow-lg text-base tracking-wide transition-all duration-300"
                  >
                ...
                <>
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gold-dark hover:bg-gold text-white font-semibold py-3 shadow-lg text-base tracking-wide transition-all duration-300"
              ...
              <p className="text-center text-sm text-gray-600">
                ...
                <a href="#" className="font-medium text-gold-dark hover:text-gold transition-colors duration-300" onClick={onSwitchToSignup}>
                  Sign up
                </a>
              </p>
            </form>
      ...
      {showSignup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" onClick={onCloseSignup}>
          <div className="bg-white rounded-lg max-w-md w-full p-6 shadow-2xl mx-auto my-auto max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-6">
              <h2 className="font-elegant text-2xl font-bold text-charcoal-dark">Create Your Account</h2>
            ...
            <form className="space-y-4" onSubmit={signupForm.handleSubmit(handleSignup)}>
              ...
              <p className="text-center text-sm text-gray-600">
                ...
                <a href="#" className="font-medium text-gold-dark hover:text-gold transition-colors duration-300" onClick={onSwitchToLogin}>
                  Login
                </a>
              </p>
            </form>
