...
fs.writeFileSync(path.join(__dirname, 'server', 'index.js'), serverIndexContent);
...
fs.writeFileSync(path.join(__dirname, 'server', 'setup-database.js'), setupDatabaseContent);
console.log('✅ Created server/setup-database.js');
