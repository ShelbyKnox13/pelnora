...
"@ | Out-File -FilePath "$tempDir/app.js" -Encoding UTF8
...
Write-Host "1. Extract pelnora-cpanel.zip" -ForegroundColor White
Write-Host "2. Upload files to your cPanel Node.js app directory" -ForegroundColor White
